...
print_r(findField("Наименование поля в Амо","Заказано","Имя или id поля в Амо",$config_params)."\n");
...
function productsInfo() //получаем инофрмацию по тавару из заказа Амо и из МойСклад
{
    ...
    foreach ($products as $prod) {
        ...
        {
            log_func([],"product not found in myStore ERRRORRRR!!!!");
