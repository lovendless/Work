<?php
  /**
  * Template Name: Invoice-payment8
  */
...
<?php include "invoice-style.php"; ?>
    ...
    <div class="other">
		...
		<!---Выберите удобный способ оплаты -->
				...
				<?php
			$tbankDetails = getPaymentReq('tbank');
			// Проверяем, есть ли ошибка в ответе
			if (!isset($tbankDetails['error'])) {
				// Если ошибки нет, показываем кнопку и данные
				$tbankCardNumCut = trim(str_replace(" ", "", $tbankDetails['cardNum']));
				$tbankReqNumCut = trim(str_replace(" ", "", $tbankDetails['req']));
			?>
            <button class="accordion" onclick="toggleAccordion(this)">
             ...
             <div class="panel">
				<ol class="numbered-list">
						<?php if ($tbankDetails['method'] == "phone"): ?>
				...
				<div class="loading-indicator" style="display: none;">
					...
					<div class="info-block column4" style="margin-top:-30px;">
                        <p style="font-size: 16px;max-width:320px;"><span class="text5">
							<?php if ($tbankDetails['method'] == "phone"): ?>
							Номер телефона</span><br/><span id="phone-numbertbank" class="phone-number" style="font-weight:700;"><?php echo $tbankDetails['phone']; ?></span>
							<?php elseif ($tbankDetails['method'] == "card"): ?>
							Номер карты</span><br/><span id="phone-numbertbank" class="phone-number" style="font-weight:700;"><?php echo $tbankDetails['cardNum']; ?></span>
							<?php elseif ($tbankDetails['method'] == "req"): ?>
							Номер счета</span><br/><span id="phone-numbertbank" class="phone-number" style="font-weight:700;"><?php echo $tbankDetails['req']; ?></span>
						<?php endif; ?>
						
						<a href="#" class="copy-button" onclick="copyNumberTbank()" title="Копировать"><i class="fas fa-copy"></i></a>
                        <p style="font-size: 16px;"><span class="text5">Получатель</span><br/><span style="color: #000; font-weight:700;"><?php echo $tbankDetails['name']; ?></span></p>
						<p style="font-size: 16px;"><span class="text5">Банк получателя</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo $tbankDetails['bank']; ?></span></p>
			...
			<?php } ?>
							...
							<?php
			$sberDetails = getPaymentReq('sber');
			// Проверяем, есть ли ошибка в ответе
			if (!isset($sberDetails['error'])) {
				// Если ошибки нет, показываем кнопку и данные
				$sberCardNumCut = trim(str_replace(" ", "", $sberDetails['cardNum']));
				$sberReqNumCut = trim(str_replace(" ", "", $sberDetails['req']));
			?>
            <button class="accordion" onclick="toggleAccordion(this)">
				...
				<div class="panel">
			<?php if ($sberDetails['method'] == "phone"): ?>
				<ol class="numbered-list">
						<li><span class="list-text">Перейдите по ссылке <a href="https://www.sberbank.com/sms/pbpn?requisiteNumber=<?php echo $sberDetails['num']; ?>">www.sberbank.com</a></span></li>
			...
			<?php elseif ($sberDetails['method'] == "card"): ?>
				<ol class="numbered-list">
						<li><span class="list-text">Перейдите по ссылке <a href="https://www.sberbank.com/sms/pbpn?requisiteNumber=<?php echo $sberDetails['num']; ?>">www.sberbank.com</a></span></li>
						<li><span class="list-text">Выполните перевод на сумму <span style="color: #000; font-weight:700;" class="price"></span></span></li>
					</ol>
			...
			<?php elseif ($sberDetails['method'] == "req"): ?>
				<ol class="numbered-list">
						<li><span class="list-text">Перейдите по ссылке <a href="https://www.sberbank.com/sms/pbpn?requisiteNumber=<?php echo $sberDetails['num']; ?>">www.sberbank.com</a></span></li>
						<li><span class="list-text">Выполните перевод на сумму <span style="color: #000; font-weight:700;" class="price"></span></span></li>
					</ol>
			...
			<?php endif; ?>
                <div id="ph-target" class="ph">
                    ...
                    <div class="info-block column4" style="margin-top:-30px;">
                        <p style="font-size: 16px;max-width:320px;"><span class="text5">
							<?php if ($sberDetails['method'] == "phone"): ?>
							Номер телефона</span><br/><span id="phone-numbersber" class="phone-number" style="font-weight:700;"><?php echo $sberDetails['phone']; ?></span>
							<?php elseif ($sberDetails['method'] == "card"): ?>
							Номер карты</span><br/><span id="phone-numbersber" class="phone-number" style="font-weight:700;"><?php echo $sberDetails['cardNum']; ?></span>
							<?php elseif ($sberDetails['method'] == "req"): ?>
							Номер счета</span><br/><span id="phone-numbersber" class="phone-number" style="font-weight:700;"><?php echo $sberDetails['req']; ?></span>
							<?php endif; ?>
                        ...
                        <p style="font-size: 16px;"><span class="text5">Получатель</span><br/><span style="color: #000; font-weight:700;"><?php echo $sberDetails['name']; ?></span></p>
						<p style="font-size: 16px;"><span class="text5">Банк получателя</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo $sberDetails['bank']; ?></span></p>
                        <p style="font-size: 16px;"><span class="text5">Сумма</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo htmlspecialchars($result['order']['price']); ?> Руб.</span></p>
			...
			$alphaDetails = getPaymentReq('alpha');
				// Проверяем, есть ли ошибка в ответе
				if (!isset($alphaDetails['error'])) {
					// Если ошибки нет, показываем кнопку и данные
					$alphaCardNumCut = trim(str_replace(" ", "", $alphaDetails['cardNum']));
					$alphaReqNumCut = trim(str_replace(" ", "", $alphaDetails['req']));
				?>
			<button class="accordion" onclick="toggleAccordion(this)">
             ...
             <div class="panel">
				<ol class="numbered-list">
					<?php if ($alphaDetails['method'] == "phone"): ?>
						<li><span class="list-text">Откройте мобильное приложение банка</span></li>
						<li><span class="list-text">Выберите перевод по <b>СБП</b></span></li>
						<li><span class="list-text">Переведите нужную сумму по номеру телефона указанному ниже:</span></li>
					<?php elseif ($alphaDetails['method'] == "card"): ?>
						<li><span class="list-text">Откройте мобильное приложение банка</span></li>
						<li><span class="list-text">Выберите перевод по <b>номеру карты</b></span></li>
						<li><span class="list-text">Переведите нужную сумму по номеру карты указанному ниже:</span></li>
					<?php elseif ($alphaDetails['method'] == "req"): ?>
						<li><span class="list-text">Откройте мобильное приложение банка</span></li>
						<li><span class="list-text">Выберите перевод по <b>номеру счета</b></span></li>
						<li><span class="list-text">Переведите нужную сумму по номеру счета указанному ниже:</span></li>
					<?php endif; ?>
				...
				<div class="loading-indicator" style="display: none;">
					...
					<?php if ($alphaDetails['method'] == "phone"): ?>
						...
						<span id="phone-numberalpha" class="phone-number" style="font-weight:700;"><?php echo $alphaDetails['phone']; ?></span>
					<?php elseif ($alphaDetails['method'] == "card"): ?>
						<p style="font-size: 16px;max-width:320px;"><span class="text5">Номер карты</span><br/>
						<span id="phone-numberalpha" class="phone-number" style="font-weight:700;"><?php echo $alphaDetails['cardNum']; ?></span>
					<?php elseif ($alphaDetails['method'] == "req"): ?>
						<p style="font-size: 16px;max-width:320px;"><span class="text5">Номер счета</span><br/>
						<span id="phone-numberalpha" class="phone-number" style="font-weight:700;"><?php echo $alphaDetails['req']; ?></span>
					<?php endif; ?>
						<a href="#" class="copy-button" onclick="copyNumberAlpha()" title="Копировать"><i class="fas fa-copy"></i></a>
                        <p style="font-size: 16px;"><span class="text5">Получатель</span><br/><span style="color: #000; font-weight:700;"><?php echo $alphaDetails['name']; ?></span></p>
						<p style="font-size: 16px;"><span class="text5">Банк получателя</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo $alphaDetails['bank']; ?></span></p>
                        <p style="font-size: 16px;"><span class="text5">Сумма</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo htmlspecialchars($result['order']['price']); ?> Руб.</span></p>
				...
				$otherDetails = getPaymentReq('other');
				// Проверяем, есть ли ошибка в ответе
				if (!isset($otherDetails['error'])) {
					// Если ошибки нет, показываем кнопку и данные
					$otherCardNumCut = trim(str_replace(" ", "", $otherDetails['cardNum']));
					$otherReqNumCut = trim(str_replace(" ", "", $otherDetails['req']));
					?>
			<button class="accordion" onclick="toggleAccordion(this)">
            ...
            <div class="panel">
                <ol class="numbered-list">
                    <?php if ($otherDetails['method'] == "phone"): ?>
						<li><span class="list-text">Откройте мобильное приложение банка</span></li>
						<li><span class="list-text">Выберите перевод по <b>СБП</b></span></li>
						<li><span class="list-text">Переведите нужную сумму по номеру телефона указанному ниже:</span></li>
					<?php elseif ($otherDetails['method'] == "card"): ?>
						<li><span class="list-text">Откройте мобильное приложение банка</span></li>
						<li><span class="list-text">Выберите перевод по <b>номеру карты</b></span></li>
						<li><span class="list-text">Переведите нужную сумму по номеру карты указанному ниже:</span></li>
					<?php elseif ($otherDetails['method'] == "req"): ?>
						<li><span class="list-text">Откройте мобильное приложение банка</span></li>
						<li><span class="list-text">Выберите перевод по <b>номеру счета</b></span></li>
						<li><span class="list-text">Переведите нужную сумму по номеру счета указанному ниже:</span></li>
					<?php endif; ?>
						...
						<div class="spinner" style="text-align:center;margin-left:auto;margin-right:auto;"></div>
                           ...
                           <div class="info-block column4" style="margin-top:-30px;">
							<p style="font-size: 16px;max-width: 300px;">
								...
								<span id="phone-numberotherbank" class="phone-number" style="font-weight:700;"><?php echo $otherDetails['phone']; ?></span>
								<?php elseif ($otherDetails['method'] == "card"): ?>
								<span class="text5">Номер карты</span><br/>
								<span id="phone-numberotherbank" class="phone-number" style="font-weight:700;"><?php echo $otherDetails['cardNum']; ?></span>
								<?php elseif ($otherDetails['method'] == "req"): ?>
								<span class="text5">Номер счета</span><br/>
								<span id="phone-numberotherbank" class="phone-number" style="font-weight:700;"><?php echo $otherDetails['req']; ?></span>
								<?php endif; ?>
							...
							<p style="font-size: 16px;"><span class="text5">Получатель</span><br/><span style="color: #000; font-weight:700;"><?php echo $otherDetails['name']; ?></span></p>
							<p style="font-size: 16px;"><span class="text5">Банк получателя</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo $otherDetails['bank']; ?></span></p>
							<p style="font-size: 16px;"><span class="text5">Сумма</span><br/><span style="color: #000; font-weight:700;" class="price"><?php echo htmlspecialchars($result['order']['price']); ?> Руб.</span></p>
